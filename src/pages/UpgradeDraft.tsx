        ...
        <div className="flex flex-wrap justify-center gap-6">
          {pool.map((u, i) => {
            ...
            return (
              ...
              >
                <Card
                  className={`relative w-64 h-64 flex flex-col p-4 ${disabled ? 'opacity-60 cursor-not-allowed' : 'cursor-pointer hover:border-primary'} transition-colors bg-card border-border glow-${u.rarity}`}
